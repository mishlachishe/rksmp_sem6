...
android {
	namespace = "ru.mishlak.rksmp_pr1_9"
	compileSdk = 36

	defaultConfig {
		applicationId = "ru.mishlak.rksmp_pr1_9"
		minSdk = 24
		targetSdk = 36
		versionCode = 1
		versionName = "1.0"
...
dependencies {
	...
	// Source: https://mvnrepository.com/artifact/androidx.work/work-runtime-ktx
	implementation("androidx.work:work-runtime-ktx:2.11.1")
	// Source: https://mvnrepository.com/artifact/androidx.compose.runtime/runtime-livedata
