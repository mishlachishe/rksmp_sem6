...
android {
	namespace = "ru.mishlak.rksmp_pr1_11"
	compileSdk = 36

	defaultConfig {
		applicationId = "ru.mishlak.rksmp_pr1_11"
		minSdk = 24
		targetSdk = 36
		versionCode = 1
		versionName = "1.0"
...
dependencies {
	...
	// Source: https://mvnrepository.com/artifact/androidx.lifecycle/lifecycle-runtime-ktx
	implementation("androidx.lifecycle:lifecycle-runtime-ktx:2.10.0")
	...
	// Source: https://mvnrepository.com/artifact/androidx.datastore/datastore-preferences-android
